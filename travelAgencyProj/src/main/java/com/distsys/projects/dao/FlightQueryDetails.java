...
public class FlightQueryDetails implements Serializable {
    ...
    public FlightQueryDetails(String origin, String destination, Date departing, Date returning, Integer no_of_seats) {
        this.origin = origin;
